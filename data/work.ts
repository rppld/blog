...
export const data: Data["work"] = [
  ...
  },
  {
    ...
    contributions: [
      "Worked with the design team the establish a company-wide design system and lead the initial implementation from a technical side.",
      "Added the first commits to what would later be turned into [Mollie’s internal component library](https://blog.mollie.com/creating-scalable-and-manageable-design-system-components-58d3ce682272).",
